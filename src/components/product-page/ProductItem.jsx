...
import { ItemName, ItemPrice } from 'components/product/ProductCard.style';
import { ItemImg, ItemContainer } from './ProductSection.style';
import useModal from 'hook/useModal';
import useConfirm from 'hook/useConfirm';
import { useNavigate } from 'react-router';
import { productDeleteAPI } from 'api/product.api';

export default function ProductItem({ id, img, name, price, link, authaccountname, update }) {
  ...
  return (
    <ItemContainer onClick={handleClickProduct}>
      <ItemImg src={img} alt="상품 미리보기 이미지" />
